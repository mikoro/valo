...
CUDA_CALLABLE float GaussianFilter::getWeight(float s)
{
...
CUDA_CALLABLE float GaussianFilter::getWeight(const Vector2& point)
{
...
CUDA_CALLABLE Vector2 GaussianFilter::getRadius()
{
