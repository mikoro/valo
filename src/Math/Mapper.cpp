...
Vector2 Mapper::mapToDisc(const Vector2& point)
{
	float phi, r;
...
Vector3 Mapper::mapToCosineHemisphere(const Vector2& point, const ONB& onb)
{
...
Vector3 Mapper::mapToUniformHemisphere(const Vector2& point, const ONB& onb)
{
	Vector2 discPoint = mapToDisc(point);
